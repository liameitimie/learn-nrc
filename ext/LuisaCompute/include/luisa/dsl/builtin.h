...
[[nodiscard]] inline auto vertex_id() noexcept {
    return def<uint>(detail::FunctionBuilder::current()->vertex_id());
}

[[nodiscard]] inline auto instance_id() noexcept {
    return def<uint>(detail::FunctionBuilder::current()->instance_id());
}
