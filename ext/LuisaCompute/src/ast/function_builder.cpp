...
const RefExpr *FunctionBuilder::vertex_id() noexcept { return _builtin(Type::of<uint>(), Variable::Tag::VERTEX_ID); }
const RefExpr *FunctionBuilder::instance_id() noexcept { return _builtin(Type::of<uint>(), Variable::Tag::INSTANCE_ID); }
